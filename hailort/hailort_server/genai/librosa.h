/**
 * NOTE: This file was copied from LibrosaCpp (https://github.com/ewan-xu/LibrosaCpp)
 * and has been modified for integration with HailoRT.
...
public:
  ...
  static Matrixf melspectrogram(Eigen::Map<const Vectorf> &x, int sr, 
