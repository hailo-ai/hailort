...
hailo_status UsbSession::wait_for_write_async_ready(size_t transfer_size, std::chrono::milliseconds timeout)
{
    (void)transfer_size;
    (void)timeout;
...
hailo_status UsbSession::write_async(TransferRequest &&request)
{
    (void)request;
    return HAILO_SUCCESS;
}

hailo_status UsbSession::wait_for_read_async_ready(size_t transfer_size, std::chrono::milliseconds timeout)
{
    (void)transfer_size;
    (void)timeout;
    return HAILO_SUCCESS;
...
hailo_status UsbSession::read_async(TransferRequest &&request)
{
    (void)request;
    return HAILO_SUCCESS;
}
