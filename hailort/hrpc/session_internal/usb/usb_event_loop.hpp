...
private:
    ...
    // This function is not thread safe and should be called only from the event loop thread
    Expected<usb_interface_t> open_interface();
    hailo_status close_interface(usb_interface_t interface);
