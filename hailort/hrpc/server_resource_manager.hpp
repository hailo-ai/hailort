 ...
 **/
/**
 * @file server_resource_manager.hpp
 * @brief manages handles for resource objects.
 *
 **/

#ifndef HAILO_SERVER_RESOURCE_MANAGER_HPP_
#define HAILO_SERVER_RESOURCE_MANAGER_HPP_
...
#endif /* HAILO_SERVER_RESOURCE_MANAGER_HPP_ */
