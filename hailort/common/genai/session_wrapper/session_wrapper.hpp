...
public:
    ...
    static Expected<uint64_t> get_file_size(const std::string &file_path);
    hailo_status send_file_chunked(const std::string &file_path, std::chrono::milliseconds timeout = LONG_TIMEOUT);
