...
#define FIRMWARE_STATUS__VARIABLES \
   ...
   FIRMWARE_STATUS__X(CONTROL_PROTOCOL_STATUS_CONTEXT_SWITCH_CONTEXT_TRANSLATION_TABLE_LENGTH_ABOVE_MAX)\
   ...
   FIRMWARE_STATUS__X(VDMA_SERVICE_STATUS_INVALID_DMA_ADDR_HANDLE)\
