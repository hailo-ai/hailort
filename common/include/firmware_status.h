...
#define FIRMWARE_STATUS__VARIABLES \
   ...
   FIRMWARE_STATUS__X(PCIE_SERVICE_STATUS_MISMATCHING_MD5) /* DEPRECATED - transport MD5 removed */\
   ...
   FIRMWARE_STATUS__X(VDMA_SERVICE_DESCS_PER_INTERRUPT_OVERFLOW)\
   \
   ...
   FIRMWARE_STATUS__X(DRAM_DMA_SERVICE_STATUS_BACK_C2C_NOT_SUPPORTED)\
   \
   ...
   \
   FIRMWARE_MODULE__X(FIRMWARE_MODULE__AHB_DMA)\
   FIRMWARE_STATUS__X(AHB_DMA_INIT_FAILED)\
   FIRMWARE_STATUS__X(AHB_DMA_NOT_ENABLED)\
   FIRMWARE_STATUS__X(AHB_DMA_ALREADY_ENABLED)\
   FIRMWARE_STATUS__X(AHB_DMA_BAD_TRANSFER_SIZE)\
